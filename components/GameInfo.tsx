    ...
    return (
        <div className="flex justify-between items-baseline pb-1">
            ...
            <div className="relative">
                ...
                {
                    showGuide && (
                        <div data-testid="GAME_GUIDE_CONTENT" className="absolute left-0 bottom-0 w-80 p-5 ml-6 bg-slate-100 text-slate-900 -translate-x-full translate-y-full z-10 rounded bg-opacity-80">
